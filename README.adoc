...
. Clone this repository: `git clone git@gitlab.fit.cvut.cz:BI-PYT/B251/{your-login}.git`
. Create a virtual environment: `python3 -m venv venv-bipyt`
